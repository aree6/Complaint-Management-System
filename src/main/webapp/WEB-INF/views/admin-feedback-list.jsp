        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td>101</td>
                    <td><a href="${pageContext.request.contextPath}/admin/feedback-details?id=1" class="btn btn-info">View</a></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Jane Smith</td>
                    ...
                    <td>102</td>
                    <td><a href="${pageContext.request.contextPath}/admin/feedback-details?id=2" class="btn btn-info">View</a></td>
                </tr>
            </tbody>
        </table>
    </div>
