            ...
            <div class="col-md-10">
                <div class="glass-container">
                    <div class="chat-header d-flex justify-content-between align-items-center" style="background: rgba(248, 249, 252, 0.01) !important;">
                        ...
                        <a href="${pageContext.request.contextPath}/technician/dashboard" class="btn-back">
                    ...
                    <form action="${pageContext.request.contextPath}/technician/chat/send" method="POST">
