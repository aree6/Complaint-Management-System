            ...
            <div class="col-12">
                <div class="quick-actions-card card shadow-sm">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button class="btn btn-primary me-2" onclick="window.location.href='${pageContext.request.contextPath}/student/complaint-form'">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn btn-sm btn-outline-primary action-btn" 
                                                        onclick="window.location.href='${pageContext.request.contextPath}/student/chat?complaintId=${complaint.id}'">
                                ...
                                <tbody>
                                    <c:forEach items="${resolvedComplaints}" var="complaint">
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-primary action-btn"
                                                    onclick="window.location.href='${pageContext.request.contextPath}/student/feedback-form'">
